...
make_fit_string_new=function(filename=NULL,others=NULL,other_model_string=NULL,is_rain=FALSE)  
{
  if(is.null(filename)){
    markov_string=NULL
    offsets=NULL
    ...
    markov_string=make_markov_string_new(params,levels,is_rain=is_rain)
